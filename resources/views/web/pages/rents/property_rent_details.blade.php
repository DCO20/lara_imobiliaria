...
<div class="inside-banner">
  ...
  @foreach ($propertyRentsRecent as $rent)
    <div class="row">
  ...
  <h2>{{  $propertyForRentsDetails->name }}</h2>
  <div class="row">
    <div class="col-lg-8">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="item active">
            <img src="{{ url("storage/{$propertyForRentsDetails->image}") }}" class="properties" alt="properties" />
          </div>
          <!-- #Item 1 -->
        </div>
  ...
  <!-- #Slider Ends -->
    ...
    <p>{{  $propertyForRentsDetails->description }}.</p>
  ...
  <p class="price">R$ {{ number_format($propertyForRentsDetails->price, 2, ',', '.') }}</p>
    <p class="area"><span class="glyphicon glyphicon-map-marker"></span> {{  $propertyForRentsDetails->city }}, {{  $propertyForRentsDetails->state }}</p>
    
  </div>
  
      <h6><span class="glyphicon glyphicon-home"></span> Disponibilidade</h6>
      <div class="listing-rent">
        <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom" data-original-title="Dormitórios">{{$propertyForRentsDetails->bedrooms}}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Suites">{{$propertyForRentsDetails->suites}}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Banheira">{{$propertyForRentsDetails->bathrooms}}</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Garagem">{{$propertyForRentsDetails->garage}}</span> </div>
        <p>Área Total = {{ $propertyForRentsDetails->area_total }} m&sup2;</p>
  </div>
  <div class="col-lg-12 col-sm-6 ">
  <div class="enquiry">
